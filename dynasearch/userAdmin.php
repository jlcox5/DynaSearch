<?php
   ...
   if( isset($_POST['save']) )
   {
      ...
      $query = "INSERT INTO t_user " .
               "(User_ID, Admin_ID, Name, UPassword, Email, User_Type, Current_Experiment_ID, current_position) " .
               "VALUES " .
               "('$pId', '$username', '$pName', '$pPassword', '$pEmail', 'U', $pCurrExp, $pProgress) " .
               "ON DUPLICATE KEY UPDATE " .
               "Name=Values(Name), UPassword=Values(UPassword), Email=Values(Email), Current_Experiment_ID=Values(Current_Experiment_ID), current_position=Values(current_position)"  . 
               ";";
