...
<body>
    ...
    <div id="wrapper" style="width:70%; margin: auto auto;">
    	...
    	<br/>
    	<br/>
		<p>From this page, you can access all of the editors to create and modify training pages, questionnaires , and complete experiments. You can also access the Official's Guide for Hurricane Evacuation Decision Making.</p>
      ...
      <li><a href="randQuestEditor.php">Questionnaire Catalog</a></li>
      <li><a href="questDisplay.php">Questionnaire Viewer</a></li>
