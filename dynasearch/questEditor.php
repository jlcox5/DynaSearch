...
<form id="To_Load">
<input type="hidden" name="questStr" value="
<?php
    ...
    if(isset($_POST['saveQuest']) && isset($_POST['questName'])){
       ...
       //echo "<div class='hiddenQuestRep' id='questSaveString'>".$text."</div>";
       echo $text;
...
<!--
<form id="POST_load" method="post">
   <input type="hidden" name="loadQuest" value="">
</form>
-->
