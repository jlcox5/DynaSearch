...
It is possible to assign users to an experiment upon user creation by clicking on the button labeled \textbf{Change} located next to the \textem{Current Experiment} field, but it is unnecessary.
