...
The results for each study can be viewed and downloaded from the \testbf{Results Manger}, as shown in Fig. \ref{fig:partResults}.  To do this, select the desired user from the dropdown list and then hit the button labaled \testbf{Load}.  Then, select the experiment you wish to review the results of and again hit the button labeled \textbf{Load}.
